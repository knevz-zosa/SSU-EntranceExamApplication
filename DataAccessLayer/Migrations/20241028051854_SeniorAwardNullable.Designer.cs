...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20241028051854_SeniorAwardNullable")]
    partial class SeniorAwardNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.AcademicBackground", b =>
                {
                    ...
                    b.Property<string>("LastAwards")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LastInclusiveYear")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PostGraduateAward")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.CouncelorConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FamilyRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FirstApplicationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.ParentGuardianInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PersonalityProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PhysicalHealth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PsychiatristConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.PsychologistConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Registered", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.SoloParent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.AcademicBackground", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.AcademicBackground", "ApplicantId")
            ...
            modelBuilder.Entity("Domain.Entities.CouncelorConsultation", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.CouncelorConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.EmergencyContact", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.EmergencyContact", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Examination", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        .WithOne("Examination")
                        .HasForeignKey("Domain.Entities.Examination", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.FirstApplicationInfo", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.FirstApplicationInfo", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.ParentGuardianInformation", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.ParentGuardianInformation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PersonalInformation", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.PersonalInformation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PersonalityProfile", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.PersonalityProfile", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PhysicalHealth", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.PhysicalHealth", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PsychiatristConsultation", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.PsychiatristConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.PsychologistConsultation", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        ...
                        .HasForeignKey("Domain.Entities.PsychologistConsultation", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Registered", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        .WithOne("Registered")
                        .HasForeignKey("Domain.Entities.Registered", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.SoloParent", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        .WithOne("SoloParent")
                        .HasForeignKey("Domain.Entities.SoloParent", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Spouse", b =>
                {
                    b.HasOne("Domain.Entities.Applicant", "Applicant")
                        .WithOne("Spouse")
                        .HasForeignKey("Domain.Entities.Spouse", "ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
